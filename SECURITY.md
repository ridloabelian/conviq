Conviq is looking forward to working with security researchers worldwide to keep Conviq and our users safe. If you have found an issue in our systems/applications, please reach out to us.
...
> Note: Please do not perform testing against Conviq production services. Use a `self-hosted instance` to perform tests.
...
Thank you for keeping Conviq and our users safe. 🙇
