...
(async () => {
  ...
  console.log('Navigating to main pricing page...');
  await page.goto('https://main.conviq-website.pages.dev/pricing');
  ...
  await page.screenshot({ path: path.join(artifactDir, 'main_checkout_modal_filled.png') });
  ...
  await page.screenshot({ path: path.join(artifactDir, 'main_checkout_submit_result.png') });
