...
(async () => {
  ...
  console.log('Navigating to production pricing page...');
  ...
  await page.screenshot({ path: path.join(artifactDir, 'prod_checkout_modal_filled.png') });
  ...
  await page.screenshot({ path: path.join(artifactDir, 'prod_checkout_submit_result.png') });
