# Conviq E2E Testing - Documentation

Complete guide for writing and maintaining E2E tests for Conviq.

---

## Overview

End-to-end testing suite for Conviq built with Playwright and TypeScript using the Component Object Model (COM) pattern.
...
TEST_USER_EMAIL=admin@conviq.com
...
- Verify `.env` credentials match Conviq
...
**Timeout errors:**
- Ensure Conviq is running at `BASE_URL`
