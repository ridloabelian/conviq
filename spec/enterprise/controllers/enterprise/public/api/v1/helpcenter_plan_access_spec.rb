...
RSpec.describe 'Public Help Center Access', type: :request do
  ...
  around do |example|
    with_modified_env FRONTEND_URL: 'https://app.conviq.com', HELPCENTER_URL: 'https://help.conviq.com' do
  ...
  it 'blocks conviq-hosted portal pages when the help center feature is disabled' do
    account.disable_features!(:help_center)
    host! 'help.conviq.com'
