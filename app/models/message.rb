...
class Message < ApplicationRecord
  searchkick callbacks: false if ConviqApp.advanced_search_allowed?
  ...
  def should_index?
    return false unless ConviqApp.advanced_search_allowed?
    ...
    return false if ConviqApp.conviq_cloud? && !account.feature_enabled?('advanced_search_indexing')
