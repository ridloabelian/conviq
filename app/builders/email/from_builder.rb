class Email::FromBuilder < Email::BaseBuilder
  ...
  def build
    ...
    from_email = case email_channel_type
                 when :standard_imap_smtp,
                      ...
                      :forwarding_own_smtp
                   channel.email
                 when :imap_conviq_smtp,
                      :forwarding_conviq_smtp
  ...
  def email_channel_type
    ...
    return :imap_conviq_smtp if imap_enabled_without_smtp?
    return :forwarding_own_smtp if forwarding_with_own_smtp?
    return :forwarding_conviq_smtp if forwarding_without_smtp?
