class Api::V1::AccountsController < Api::BaseController
  ...
  def show
    @latest_conviq_version = ::Redis::Alfred.get(::Redis::Alfred::LATEST_CONVIQ_VERSION)
  ...
  def validate_captcha
    raise ActionController::InvalidAuthenticityToken, 'Invalid Captcha' unless ConviqCaptcha.new(params[:h_captcha_client_response]).valid?
  end
