...
export function useBranding() {
  ...
  /**
   * Replaces "Conviq" in text with the installation name from global config
   * @param {string} text - The text to process
   * @returns {string} - Text with "Conviq" replaced by installation name
   */
  const replaceInstallationName = text => {
    ...
    return text.replace(/Conviq/g, installationName);
  };
