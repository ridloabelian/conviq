...
const isAConviqInstance = computed(
  () => globalConfig.value.installationName === 'Conviq'
);

onBeforeMount(() => {
  isLoading.value = isAConviqInstance.value;
});
...
<template>
  ...
  >
    ...
    <div
      ...
      :class="{ 'w-auto xl:w-full': isAConviqInstance }"
    >
