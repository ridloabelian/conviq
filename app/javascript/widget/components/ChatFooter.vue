...
import { CONVIQ_ON_START_CONVERSATION } from '../constants/sdkEvents';
...
export default {
  ...
  computed: {
    ...
    hideReplyBox() {
      const { allowMessagesAfterResolved } = window.conviqWebChannel;
  ...
  methods: {
    ...
    startNewConversation() {
      ...
      IFrameHelper.sendMessage({
        event: 'onEvent',
        eventIdentifier: CONVIQ_ON_START_CONVERSATION,
