export default {
  computed: {
    ...
    hasAConnectedAgentBot() {
      return !!window.conviqWebChannel.hasAConnectedAgentBot;
    },
    inboxAvatarUrl() {
      return window.conviqWebChannel.avatarUrl;
    },
    channelConfig() {
      return window.conviqWebChannel;
    },
    ...
    preChatFormEnabled() {
      return window.conviqWebChannel.preChatFormEnabled;
    },
    preChatFormOptions() {
      let preChatMessage = '';
      const options = window.conviqWebChannel.preChatFormOptions || {};
