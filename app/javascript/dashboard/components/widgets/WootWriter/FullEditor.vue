...
import {
  suggestionsPlugin,
  triggerCharacters,
} from '@conviq/prosemirror-schema/src/mentions/plugin';
import imagePastePlugin from '@conviq/prosemirror-schema/src/plugins/image';
import embedPreviewPlugin from '@conviq/prosemirror-schema/src/plugins/embedPreview';
import trailingParagraphPlugin from '@conviq/prosemirror-schema/src/plugins/trailingParagraph';
import { embeds as markdownEmbeds } from 'dashboard/helper/markdownEmbeds';
import { toggleMark } from 'prosemirror-commands';
import { wrapInList } from 'prosemirror-schema-list';
import { toggleBlockType } from '@conviq/prosemirror-schema/src/menu/common';
...
<style lang="scss">
@import '@conviq/prosemirror-schema/src/styles/article.scss';
