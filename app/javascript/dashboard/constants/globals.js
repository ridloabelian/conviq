export default {
  ...
  DOCS_URL: 'https://www.conviq.com/docs/product/',
  HELP_CENTER_DOCS_URL:
    'https://www.conviq.com/docs/product/others/help-center',
  TESTIMONIAL_URL:
    'https://testimonials.cdn.conviq.com/testimonial-content.json',
