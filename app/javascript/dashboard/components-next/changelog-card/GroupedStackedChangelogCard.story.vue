...
const sampleCards = [
  {
    id: 'conviq-captain',
    title: 'Conviq Captain',
    meta_title: 'Conviq Captain',
    meta_description:
      'Watch how our latest feature can transform your workflow with powerful automation tools.',
    slug: 'conviq-captain',
    feature_image:
      'https://www.conviq.com/images/captain/captain_thumbnail.jpg',
  },
  {
    id: 'smart-routing',
    ...
    slug: 'smart-routing',
    feature_image: 'https://www.conviq.com/images/dashboard-dark.webp',
  },
  {
    id: 'instant-meetings',
