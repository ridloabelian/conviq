export const twilioTemplates = [
  ...
  {
    body: 'What type of Conviq installation are you using? Select "Conviq Cloud" if you are using app.conviq.com, otherwise select "Self-hosted Conviq".',
    types: {
      'twilio/quick-reply': {
        body: 'What type of Conviq installation are you using? Select "Conviq Cloud" if you are using app.conviq.com, otherwise select "Self-hosted Conviq".',
        actions: [
          {
            id: 'Conviq Cloud_payload',
            title: 'Conviq Cloud',
          },
          {
            id: 'Self-hosted Conviq_payload',
            title: 'Self-hosted Conviq',
          },
        ],
      },
    },
