...
const { t } = useI18n();
const { currentAccount, accountId, isOnConviqCloud, updateAccount } =
  useAccount();
...
const showPaywall = computed(() => !props.isEnabled && isOnConviqCloud.value);
const i18nKey = computed(() =>
  isOnConviqCloud.value ? 'PAYWALL' : 'ENTERPRISE_PAYWALL'
);
...
<template>
  ...
  >
    ...
    <BasePaywallModal
      ...
      :i18n-key="i18nKey"
      :is-on-conviq-cloud="isOnConviqCloud"
