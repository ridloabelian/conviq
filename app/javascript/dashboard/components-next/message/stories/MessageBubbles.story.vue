...
const getMessage = overrides => {
  ...
  return {
    id: 5272,
    content: 'Hey, how are ya, I had a few questions about Conviq?',
    inboxId: 475,
    conversationId: 43,
    messageType: 0,
    contentType: 'text',
...
const email = computed(() =>
  getMessage({
    ...
    attachments: [
      ...
      getAttachment('file', 'https://conviq.dev/invoice.pdf'),
      getAttachment('file', 'https://conviq.dev/logs.txt'),
      getAttachment('file', 'https://conviq.dev/contacts.xls'),
      getAttachment('file', 'https://conviq.dev/customers.csv'),
      getAttachment('file', 'https://conviq.dev/warehousing-policy.docx'),
      getAttachment('file', 'https://conviq.dev/pitch-deck.ppt'),
      getAttachment('file', 'https://conviq.dev/all-files.tar'),
      getAttachment(
        'audio',
