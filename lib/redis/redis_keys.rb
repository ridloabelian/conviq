module Redis::RedisKeys
  ...
  CONVIQ_INSTALLATION_ONBOARDING = 'CONVIQ_INSTALLATION_ONBOARDING'.freeze
  CONVIQ_INSTALLATION_CONFIG_RESET_WARNING = 'CONVIQ_CONFIG_RESET_WARNING'.freeze
  LATEST_CONVIQ_VERSION = 'LATEST_CONVIQ_VERSION'.freeze
